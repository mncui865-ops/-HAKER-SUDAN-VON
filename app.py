# ================================================================
# REAL PREDATOR SD v22.0 ULTIMATE - RENDER FULLY COMPATIBLE
...
def bot_listener():
    """Telegram bot listener with automatic reconnection and Render compatibility."""
    last_update_id = 0
    ...
    while state.bot_running:
        try:
            ...
            if consecutive_errors > 10:
                print(f"[Bot] Too many errors ({consecutive_errors}), waiting 30 seconds...")
                time.sleep(30)
                consecutive_errors = 0
            else:
                time.sleep(1)
...
if __name__ == '__main__':
    # Start bot listener in daemon thread
    bot_thread = threading.Thread(target=bot_listener, daemon=True)
    bot_thread.start()
