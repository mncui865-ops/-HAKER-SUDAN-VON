...
PLATFORMS = [
    ...
    {'name':'Gmail','icon':'fa-brands fa-google','color':'#ea4335','check':'gmail','gaming':False,'supports_phone':False},
    {'name':'Microsoft','icon':'fa-solid fa-envelope','color':'#0078D4','check':'microsoft','gaming':False,'supports_phone':False},
    {'name':'Outlook','icon':'fa-solid fa-envelope','color':'#0078D4','check':'outlook','gaming':False,'supports_phone':False},
    ...
    {'name':'iCloud','icon':'fa-brands fa-apple','color':'#555555','check':'icloud','gaming':False,'supports_phone':False},
    ...
    {'name':'EA Sports','icon':'fa-solid fa-gamepad','color':'#FF0000','check':'ea','gaming':True,'supports_phone':False},
    {'name':'GOG','icon':'fa-solid fa-gamepad','color':'#86328A','check':'gog','gaming':True,'supports_phone':False},
    {'name':'Battle.net','icon':'fa-solid fa-gamepad','color':'#00AEFF','check':'battlenet','gaming':True,'supports_phone':False},
    {'name':'Minecraft','icon':'fa-solid fa-cube','color':'#5A9C4E','check':'minecraft','gaming':True,'supports_phone':False},
    {'name':'Roblox','icon':'fa-solid fa-cube','color':'#000000','check':'roblox','gaming':True,'supports_phone':False},
    {'name':'Valorant','icon':'fa-solid fa-crosshairs','color':'#FF4655','check':'valorant','gaming':True,'supports_phone':False},
    {'name':'Fortnite','icon':'fa-solid fa-skull','color':'#7B42BC','check':'fortnite','gaming':True,'supports_phone':False},
    {'name':'Apex Legends','icon':'fa-solid fa-shield','color':'#FF0000','check':'apex','gaming':True,'supports_phone':False},
    ...
    {'name':'YouTube','icon':'fa-brands fa-youtube','color':'#FF0000','check':'youtube','gaming':False,'supports_phone':False},
    ...
    # AI Platforms
    {'name':'ChatGPT','icon':'fa-solid fa-robot','color':'#10a37f','check':'chatgpt','gaming':False,'supports_phone':False},
    {'name':'Claude','icon':'fa-solid fa-brain','color':'#7C3AED','check':'claude','gaming':False,'supports_phone':False},
    {'name':'DeepSeek','icon':'fa-solid fa-microchip','color':'#00B4D8','check':'deepseek','gaming':False,'supports_phone':False},
    {'name':'Perplexity','icon':'fa-solid fa-search','color':'#1A1A1A','check':'perplexity','gaming':False,'supports_phone':False},
    {'name':'Gemini','icon':'fa-brands fa-google','color':'#4285F4','check':'gemini','gaming':False,'supports_phone':False},
    {'name':'Copilot','icon':'fa-solid fa-code','color':'#00A4EF','check':'copilot','gaming':False,'supports_phone':False},
    {'name':'Mistral','icon':'fa-solid fa-cloud','color':'#FF6B00','check':'mistral','gaming':False,'supports_phone':False},
    {'name':'Hugging Face','icon':'fa-solid fa-hug','color':'#FFD21E','check':'huggingface','gaming':False,'supports_phone':False},
    ...
    {'name':'Slack','icon':'fa-brands fa-slack','color':'#4A154B','check':'slack','gaming':False,'supports_phone':False},
]
...
@media(max-width:768px){.stats-rectangle{grid-template-columns:repeat(3,1fr)}.platform-grid{grid-template-columns:repeat(auto-fill,minmax(120px,1fr))}}
</style>
</head>
<body>
<div class="container">
    ...
    <div class="card">
        <div class="platform-grid-title">
            <span>📱 <span style="color:#00ff41;">{{ platforms|length }}</span> Platforms</span>
            <span>🎮 <span style="color:#ffd700;">Gaming</span></span>
            <span>🤖 <span style="color:#00B4D8;">AI</span></span>
            <span>💰 <span style="color:#F0B90B;">Crypto</span></span>
        </div>
        <div class="platform-grid">
            {% for p in platforms %}
            <div class="platform-badge">
                <span class="icon" style="color:{{ p.color }};"><i class="{{ p.icon }}"></i></span>
...
console.log('✅ {{ platforms|length }} platforms with icons');
</script>
</body>
</html>'''
...
╚══════════════════════════════════════════════════════════════════╝
    ...
    print(f"[*] {len(PLATFORMS)} Platforms loaded with icons")
    print(f"[*] Speed: 5 accounts/minute")
